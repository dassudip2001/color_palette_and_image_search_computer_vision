...
# dir path
dir_path='../segmentation/data'

# get all image path
images_path=glob.glob(os.path.join(dir_path,'*.jpg'))
images_path.extend(glob.glob(os.path.join(dir_path,'*.png')))
...
# csv data
    ...
    # for i in range(len(row)):
        # print(row[i])
        # index auto increment by 1 
        # how to generate unique uuid for each image

        csv_data.append([str(imageUuid), row,images_path])
